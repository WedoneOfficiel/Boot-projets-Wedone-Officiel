...
// Ajouter un écouteur d'événement click sur le bouton pour importer les données
importBtn.addEventListener("click", function() {
    // Cliquer sur l'input de type file pour ouvrir la boîte de dialogue d'importation
    importFile.click();
});

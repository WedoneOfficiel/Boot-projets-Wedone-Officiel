...
if( /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) ) {
 alert("Veuillez vous connecter avec un ordinateur pour une meilleure expérience d'utilisateion.");
...
if($(window).width() < 800){
  alert("Veuillez maximiser la taille de la fenêtre pour une expérience optimale.");
  $("#notepad").hide()
  $("#winver").hide()
}
}
...
if(jsmm < 11) var mm = "0" + (jsmm + 1); // Fix JavaScript months, which are base 0 instead of base 1
else var mm = jsmm + 1; 
...
$(document).ready(function() {
	...
	$("#edgeIconFrame").click(function() {
		alert("Indisponible dans cette version");
	});
